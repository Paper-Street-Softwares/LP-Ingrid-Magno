  ...
  const renderHeroContent = ({
    ...
    return (
      <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
        ...
        <MotionDivDownToUp>
          <div
            className={`flex justify-center desktop1:justify-start font-bold leading-[40px] phone3:leading-[42px] tablet1:leading-[70px] desktop1:leading-[60px] desktop2:leading-[55px] text-center desktop1:text-left text-title4 phone2:text-title5 phone3:text-title5 tablet1:text-title6 ${titleTextColor}`}
          >
