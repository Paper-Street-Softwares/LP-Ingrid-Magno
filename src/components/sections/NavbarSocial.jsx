        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[30%] mw-[50%] tablet2:w-[40%] desktop1:w-[30%] transition-all duration-1000"
                  : "my-[20px] w-[40%] tablet1:w-[40%] tablet2:w-[50%] desktop1:w-[40%] desktop2:w-[50%] transition-all duration-1000"
              } tablet3:mb-0`}
            />
          </ScrollLink>
